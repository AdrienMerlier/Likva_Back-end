module.exports = function(app){
    ...
    app.get('/api/teams/:teamId/changePrivacy', teams.changePrivacy);
    ...
    app.post('/api/teams/:teamId/admin/modifyUser', teamUsers.updateRights);
    app.post('/api/teams/:teamId/users/erase', teamUsers.eraseUser);
